const translations = {
    ka: {
        ...
        enterIdPhoneOrName: 'შეიყვანეთ პირადი ნომერი, ტელეფონი ან სახელი',
        nameTooShort: 'სახელი უნდა შეიცავდეს მინიმუმ 3 სიმბოლოს',
        invalidPersonalId: 'პირადი ნომერი უნდა შეიცავდეს მხოლოდ ციფრებს',
    ...
    en: {
        ...
        enterIdPhoneOrName: 'Enter ID number, phone or name',
        nameTooShort: 'Enter at least 3 characters of the name',
        invalidPersonalId: 'Personal ID must contain digits only',
