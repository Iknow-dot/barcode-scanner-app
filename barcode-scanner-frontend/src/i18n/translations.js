const translations = {
    ka: {
        ...
        delete: 'წაშლა',
        close: 'დახურვა',
        destructiveAction: 'საშიში მოქმედება',
        yes: 'დიახ',
        no: 'არა',
        error: 'შეცდომა',
        success: 'წარმატება',
        ...
        cameraPermissionDenied: 'კამერაზე წვდომა აკრძალულია. დაუშვით წვდომა ბრაუზერის საიტის პარამეტრებში.',
        cameraNotFound: 'კამერა ვერ მოიძებნა ამ მოწყობილობაზე.',
        cameraBusy: 'კამერას სხვა აპლიკაცია იყენებს. დახურეთ სხვა აპლიკაცია და სცადეთ ხელახლა.',
        retry: 'სცადეთ ხელახლა',
        torchToggle: 'ფანარი',
        flipCamera: 'კამერის გადართვა',
        warehouse: 'საწყობი',
        balance: 'ნაშთი',
        price: 'ფასი',
        ...
        gatewayError: 'სერვერმა პასუხი ვერ დააბრუნა. გთხოვთ, სცადოთ მოგვიანებით.',
        ...
        productCatalogEnabled: 'პროდუქტების კატალოგი',
        productCatalogHint: 'ლოკალური კატალოგი: 1C-დან ატვირთვა და კონსულტანტების ძებნა/დათვალიერება',
        productLimit: 'პროდუქტების ლიმიტი',
        productLimitHint: 'აქტიური პროდუქტების მაქსიმალური რაოდენობა კატალოგში',
        productLimitUnlimited: 'ულიმიტო',
        ...
        passwordTooCommon: 'ეს პაროლი ძალიან გავრცელებულია.',
        passwordEntirelyNumeric: 'პაროლი არ შეიძლება შედგებოდეს მხოლოდ ციფრებისგან.',
        passwordTooSimilar: 'პაროლი ძალიან ჰგავს მომხმარებლის სახელს ან მონაცემებს.',
        ...
        clientCreateUnverified: 'ვერ დადასტურდა, შეიქმნა თუ არა კლიენტი. ხელახლა შექმნამდე მოძებნეთ იგი.',
        ...
        lookupIdHint: 'მინიმუმ 9 ციფრი',
        lookupPhoneHint: 'მობილურის ნომერი იწყება 5-ით',
        lookupNameHint: 'მინიმუმ 3 სიმბოლო',
        clientsFoundCount: 'კლიენტი',
        ...
        discountExceedsLimit: (max) => `ფასდაკლება აღემატება თქვენს ლიმიტს (${max}%)`,
        insufficientStockTitle: 'არასაკმარისი ნაშთი',
        insufficientStockLine: (requested, available) => `მოთხოვნილია ${requested}, თავისუფალია ${available}`,
        insufficientStockGeneric: 'მოთხოვნილი რაოდენობა აღემატება თავისუფალ ნაშთს',
        orderCreateRejectedTitle: 'შეკვეთა უარყოფილია',
        orderCreateRejected: '1C-მა უარყო შეკვეთა',
        multipleWarehousesError: '1C იღებს შეკვეთას მხოლოდ ერთი საწყობიდან — დასადასტურებლად ყველა პროდუქტი ერთ საწყობში უნდა იყოს',
        missingWarehouseError: 'შეკვეთის პროდუქტებს საწყობი არ აქვთ მითითებული — დადასტურებისთვის საჭიროა საწყობი',
        emptyOrderError: 'ცარიელი შეკვეთის დადასტურება შეუძლებელია — დაამატეთ მინიმუმ ერთი პროდუქტი',
        itemLookupKeyMissingError: (name) => `პროდუქტს „${name}“ არ აქვს არტიკული ან შტრიხკოდი 1C-ში გასაგზავნად`,
        itemLookupKeyMissingGeneric: 'პროდუქტს არ აქვს არტიკული ან შტრიხკოდი 1C-ში გასაგზავნად',
        missingClientError: 'შეკვეთას კლიენტი არ აქვს — კლიენტის გარეშე დადასტურება მხოლოდ საცალო შეკვეთას შეუძლია',
        reserveLabel: 'რეზერვი',
        freeStockLabel: 'თავისუფალი',
        catalogLockedTitle: 'პროდუქტების კატალოგი დაბლოკილია',
        catalogLockedDesc: 'იხილეთ თქვენი პროდუქტების სრული კატალოგი — სინქრონიზაციის სტატუსი, კატეგორიები, ფილტრები და პროდუქტების დეტალები ერთ სივრცეში.',
        unlockFeature: 'განბლოკვა',
        unlockContactHint: 'ამ ფუნქციის გასააქტიურებლად დაუკავშირდით iKnow-ს — ფუნქცია თქვენი ორგანიზაციისთვის ჩაირთვება სისტემის ადმინისტრატორის მიერ.',
        ...
        searchCatalog: 'ძებნა: სახელი / SKU / შტრიხკოდი / არტიკული',
        catalogAll: 'ყველა',
        ...
        stockLookupKeyMissing: 'ამ პროდუქტს არ აქვს არტიკული ან შტრიხკოდი — ნაშთის მოთხოვნა ვერ ხერხდება',
        ...
        noOrdersInSegment: 'დღეს ამ სექციაში შეკვეთები არ არის',
        today: 'დღეს',
        justNow: 'ახლახან',
    ...
    en: {
        ...
        cameraPermissionDenied: 'Camera access was denied. Allow camera access in your browser\'s site settings.',
        cameraNotFound: 'No camera was found on this device.',
        cameraBusy: 'The camera is in use by another app. Close the other app and try again.',
        retry: 'Retry',
        ...
        gatewayError: 'The server did not return a response. Please try again in a moment.',
        ...
        productCatalogEnabled: 'Product catalog',
        productCatalogHint: 'Local catalog: 1C pushes and consultant search/browse',
        productLimit: 'Product limit',
        productLimitHint: 'Maximum number of active catalog products',
        productLimitUnlimited: 'Unlimited',
        ...
        passwordEntirelyNumeric: 'The password can\'t be only digits.',
        passwordTooSimilar: 'The password is too similar to the username or name.',
        ...
        clientCreateUnverified: 'Could not confirm whether the client was created. Search for them before creating again.',
        ...
        lookupByIdTab: 'ID number',
        lookupByPhoneTab: 'Phone',
        lookupByNameTab: 'Name',
        lookupIdPlaceholder: 'Personal or tax ID',
        lookupPhonePlaceholder: '5XX XX XX XX',
        lookupNamePlaceholder: 'Last or first name',
        lookupIdHint: 'At least 9 digits',
        lookupPhoneHint: 'A mobile number starting with 5',
        lookupNameHint: 'At least 3 characters',
        clientsFoundCount: 'clients',
        createClientRow: 'Create client',
        clearSearch: 'Clear',
        searchAction: 'Search',
        back: 'Back',
        customer: 'Client',
        ...
        discountExceedsLimit: (max) => `Discount exceeds your limit (${max}%).`,
        insufficientStockTitle: 'Insufficient stock',
        insufficientStockLine: (requested, available) => `requested ${requested}, available ${available}`,
        insufficientStockGeneric: 'Requested quantity exceeds free stock',
        orderCreateRejectedTitle: 'Order rejected',
        orderCreateRejected: '1C rejected the order',
        multipleWarehousesError: '1C accepts one warehouse per order — all items must share a warehouse to confirm',
        missingWarehouseError: 'Order items have no warehouse — a warehouse is required to confirm',
        emptyOrderError: 'An empty order cannot be confirmed — add at least one product',
        itemLookupKeyMissingError: (name) => `Product “${name}” has no article or barcode to send to 1C`,
        itemLookupKeyMissingGeneric: 'A product has no article or barcode to send to 1C',
        missingClientError: 'The order has no client — only retail orders can confirm without one',
        reserveLabel: 'Reserved',
        freeStockLabel: 'Free',
        catalogLockedTitle: 'Product catalog is locked',
        catalogLockedDesc: 'Browse your full product catalog — sync status, categories, filters and product details in one place.',
        unlockFeature: 'Unlock',
        unlockContactHint: 'Contact iKnow to activate this feature — it is enabled for your organization by a system administrator.',
        ...
        refreshData: 'Refresh',
        searchCatalog: 'Search: name / SKU / barcode / article',
        catalogAll: 'All',
        ...
        stockLookupKeyMissing: 'This product has no article or barcode, so stock cannot be requested',
        ...
        noOrdersInSegment: 'No orders in this section today',
        today: 'Today',
        justNow: 'just now',
        minAgo: (n) => `${n} min ago`,
        // groupByDay's own "yesterday" heading — a distinct key from dayAgo
