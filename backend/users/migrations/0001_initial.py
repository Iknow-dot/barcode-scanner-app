    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('internal_admin', 'Internal Admin'), ('company_admin', 'Company Admin'), ('company_user', 'Company User')], default='company_user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip_or_network', models.CharField(help_text='IP Address or Network', max_length=50)),
