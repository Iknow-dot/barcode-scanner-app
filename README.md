...
- [`docs/architecture/`](docs/architecture/README.md) — system-wide UML diagrams (Mermaid), derived from the code:
  - [Use cases & role access](docs/architecture/01-use-cases.md)
  - [Domain model (ER + class diagram)](docs/architecture/02-domain-model.md)
...
│   └── Dockerfile
├── docs/
│   ├── architecture/                # system-wide UML diagrams (Mermaid)
│   └── superpowers/                 # per-feature design specs + implementation plans
