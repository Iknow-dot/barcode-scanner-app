...
const UsersTab = ({
    ...
    const handleAdd = async (newUser) => {
        ...
        try {
            ...
            if (message === "User limit for this organization has been reached") {
                setNotificationData({
                    type: 'error',
                    message: 'შეცდომა',
                    description: `მომხმარებელთა ლიმიტი ამ ორგანიზაციისთვის ამოწურულია. გთხოვთ, დაუკავშირდით სისტემის ადმინისტრატორს.`,
                });
            } else {
                setNotificationData({
                    type: 'error',
                    message: 'შეცდომა',
                    description: `მომხმარებლის შექმნისას შეცდომა "(${message})"`
                });
            }
